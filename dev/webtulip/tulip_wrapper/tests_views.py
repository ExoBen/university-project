...
class ViewsTest(TestCase):
    ...
    def test_base(self):
        response = client.get(reverse('loadGraph'), {'network_name': 'sas_30_test'})
    ...
    def test_prune(self):
        response = client.get(reverse('loadGraph'), {'network_name': 'sas_30_test', 'toPrune': 'true'})
        dict_response = json.loads(response.content.decode('utf-8'))
    ...
    def test_edge(self):
        response = client.get(reverse('loadGraph'), {'network_name': 'sas_30_test', 'toEdgeBundle': 'true'})
        dict_response = json.loads(response.content.decode('utf-8'))
    ...
    def test_prune_and_edge(self):
        response = client.get(reverse('loadGraph'), {'network_name': 'sas_30_test', 'toEdgeBundle': 'true', 'toPrune': 'true'})
        dict_response = json.loads(response.content.decode('utf-8'))
